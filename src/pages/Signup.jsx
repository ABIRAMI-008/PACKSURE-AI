          ...
          <section className="hidden lg:flex bg-slate-950 text-white p-12 flex-col justify-between min-h-[680px]">
            ...
            <div>
              ...
              <p className="mt-6 text-slate-400 leading-7 max-w-md">
                Create your PackSure AI account and start transforming
                packaging compliance into actionable intelligence.
              </p>
            ...
            <div className="space-y-4">
              ...
              <Feature text="Detailed compliance reports" />
            ...
            <div className="max-w-md w-full mx-auto">
              ...
              <div className="mb-7">
                ...
                <p className="mt-2 text-slate-500 text-sm">
                  Join PackSure AI and simplify packaging compliance.
                </p>
              ...
              <form onSubmit={handleSignup} className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className="w-full h-12 pl-11 pr-4 rounded-lg border border-slate-300 outline-none focus:border-teal-600 focus:ring-2 focus:ring-teal-100 transition"
                    />
                ...
                <div>
                  ...
                  <select
                    ...
                    className="w-full h-12 px-4 rounded-lg border border-slate-300 bg-white text-slate-700 outline-none focus:border-teal-600 focus:ring-2 focus:ring-teal-100 transition"
                  >
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input
                      ...
                      required
                      className="w-full h-12 pl-11 pr-12 rounded-lg border border-slate-300 outline-none focus:border-teal-600 focus:ring-2 focus:ring-teal-100 transition"
                    />
